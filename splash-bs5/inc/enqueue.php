...
function enqueue_my_admin_scripts($hook) {
    ...
    wp_enqueue_style( 'insta-admin', get_stylesheet_directory_uri() . '/admin/css/insta-admin.css', array(), VERSION, 'all' );
    wp_enqueue_script( 'insta-admin', get_template_directory_uri() . '/admin/js/insta-admin.js', array('jquery'), VERSION, true );
}
